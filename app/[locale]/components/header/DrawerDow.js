...
export const DrawerDow = ({
  ...
  return (
    <div className="flex ltr:bg-black rtl:bg-red-500 flex-col absolute ltr:left-0 rtl:right-0 top-[1.82rem] w-full">
      <div
        className={`${
          showOptions ? "max-h-[1000px] " : "max-h-[0px] "
        } overflow-hidden z-30 flex w-full justify-center transition-all duration-[300ms] bg-[#F5F6F8]`}
      >
