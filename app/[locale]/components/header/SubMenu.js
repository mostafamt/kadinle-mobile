...
export const SubMenu = ({ categories, language }) => {
  ...
  return (
    <nav className="flex flex-col relative menu bg-primary md:px-8 lg:px-12">
      <div className="relative">
        ...
        >
          <ul className="flex items-center w-full justify-between scroll-hide text-white gap-5 px-4 py-3 overflow-auto">
            {links?.map((link) => (
